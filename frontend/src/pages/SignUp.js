...
const SignUp = () => {
        ...
        if (isValid) {
            ...
            try{
                ...
                if (error.response && error.response.status === 400) {
                    ...
                    setDialogMessage('An error occurred while registering. Please try again later.');
                    setOpenDialog(true);
                }
            }
        } else {
    ...
    return (
        <div>
            <Container maxWidth="sm" sx={{ border:"1px solid black", borderRadius: '20px' }}>
                <Box sx={{
                    // marginTop: 8,
                    m: '30px',
                    display: "flex",
                    ...
                    <Box sx={{width: '100%', mt: '20px' }}>
                        <Grid2 container spacing={4} sx={{width:'100%'}}>
                            ...
                            <Grid2 size={12} sx={{ width: '100%', display: 'flex', justifyContent: 'start' }}>
